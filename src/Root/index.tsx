...
function Root() {
    ...
    // isVisibleIndex = isVisibleIndex >= 0 ? isVisibleIndex : 0;
    ...
    return (
        <div className="main">
            ...
            <SideNavControl isVisibleIndex={isVisibleIndex} key="side-nav-control"/>
        </div>
    );
}
...
function Profile(prop: SectionPropType) {
    ...
    return (
        <div className="profile" id="profile" ref={nodeRef}>
            <div className="profile-info">
                ...
                <span className="resume"><DocumentIcon /><a href={Pdf}>See my resume</a></span>
            </div>
...
function Experience(prop: SectionPropType) {
    ...
    return (
        <div className="experience" id="experience" ref={nodeRef}>
            <h1>Experience.</h1>
...
function Projects(prop: SectionPropType) {
    ...
    return (
        <div className="projects" id="projects" ref={nodeRef}>
            <h1>Projects.</h1>
            <p>Nec lobortis suspendisse magna convallis turpis metus natoque facilisi ornare. Sollicitudin conubia in scelerisque suspendisse congue ad platea torquent.</p>
...
function Blog(prop: SectionPropType) {
    ...
    return (
        <div className="blog" id="blog" ref={nodeRef}>
            <h1>Blog.</h1>
            {[0].map((_, index) => {
                return (
...
function Contact(prop: SectionPropType) {
    ...
    return (
        <div className="contact" id="contact" ref={nodeRef}>
            <h1>Contact.</h1>
...
function DocumentIcon() {
    return (
        <svg className="only-stroke" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 13V9C1 5.229 1 3.343 2.172 2.172C3.344 1.001 5.229 1 9 1H11C14.771 1 16.657 1 17.828 2.172C18.482 2.825 18.771 3.7 18.898 5M19 9V13C19 16.771 19 18.657 17.828 19.828C16.656 20.999 14.771 21 11 21H9C5.229 21 3.343 21 2.172 19.828C1.518 19.175 1.229 18.3 1.102 17M6 13H11M6 9H7M14 9H10" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
    );
}
